import { Clock, Gamepad2, LibraryBig, Trophy, UserRound } from "lucide-react";
      ...
      <Card className="border border-1 border-violet-200 bg-purple-50/30 dark:border-gray-700">
        <div className="flex flex-col gap-4 text-black dark:text-white">
          <div className="flex flex-row items-center gap-4">
            <div className="bg-purple-200 p-2 rounded-full text-fuchsia-800 dark:bg-purple-800 dark:text-purple-200">
              <UserRound size={30} />
            </div>
            <div>
              <p className="text-xl font-semibold">Jisung</p>
              <p className="text-sm">6 games in collection</p>
            </div>
          </div>
